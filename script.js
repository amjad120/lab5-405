...
populateTable(data);
            ...
            function filterName() {
                let word = searchInputElem.value.toLowerCase();
            ...
            function filter(rows, columns, word) {
                
                for  (let i = 0; i < rows.length; i++) {
                    let td = rows[i].getElementsByTagName("td")[columns];
         ...
         searchInputElem.addEventListener("keyup",filterName);
